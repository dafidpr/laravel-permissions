    ...
    <div class="modal-dialog modal-dialog-top" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-lg">
                <h5 class="title">Add New Permission</h5>
                            ...
                            <div class="row gy-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" for="">Permission Name <span class="text-danger">*</span></label>
                                        <div class="form-control-wrap">
                                            <div class="form-icon form-icon-left">
                                                <em class="icon ni ni-shield-star"></em>
                                            </div>
                                            <input type="text" class="form-control form-control-lg" name="name" id="name" placeholder="Permission Name" autocomplete="off">
                                        </div>
