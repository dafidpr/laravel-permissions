                        ...
                        <div class="row gy-4">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label" for="default-03">Current Password <span class="text-danger">*</span></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label" for="default-03">New Password <span class="text-danger">*</span></label>
                                    <div class="form-control-wrap">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label" for="default-03">Confirm Password <span class="text-danger">*</span></label>
                                    <div class="form-control-wrap">
