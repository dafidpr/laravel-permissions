                ...
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li><a href="/administrator/menus/create" class="btn btn-light bg-white"><em class="icon ni ni-plus"></em><span>Add New Menu</span></a></li>
                        </ul>
                    </div>
                </div><!-- .toggle-wrap -->
            </div><!-- .nk-block-head-content -->
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head">
                                    ...
                                    <div class="nk-tb-col tb-col-lg"><span class="sub-text">Target</span></div>
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head">
                                    ...
                                    <div class="nk-tb-col tb-col-md"><span class="sub-text">Position</span></div>
                                    <div class="nk-tb-col tb-col-lg"><span class="sub-text">Target</span></div>
                                    <div class="nk-tb-col tb-col-lg"><span class="sub-text">Group</span></div>
                                    <div class="nk-tb-col nk-tb-col-tools text-right"></div>
                                </div><!-- .nk-tb-item -->
